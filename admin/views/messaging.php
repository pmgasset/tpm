...
$placeholders    = [
    ...
    '{{site_url}}'           => __( 'Site URL (shortened when configured)', 'vr-single-property' ),
    '{{site_url_short}}'     => __( 'Shortened site URL (falls back to full URL)', 'vr-single-property' ),
    '{{site_url_full}}'      => __( 'Full site URL', 'vr-single-property' ),
